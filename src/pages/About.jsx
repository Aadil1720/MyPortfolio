      ...
      <section className='featured-box about-text'>
        <div className="featured-text">
          ...
          <p className="featured-name">
            <ReactTypingEffect
              text={['Data Engineer', 'Databricks-Certified', 'Java Developer']}
              speed={200}
              eraseSpeed={100}
              eraseDelay={1500}
              typingDelay={1000}
...
<p>
  ...
  <strong>Spring Boot</strong>, and RESTful APIs.
          ...
          <div className="text-btn">
            ...
            <button className="btn" onClick={() => handleDownload('https://docs.google.com/document/d/1P4_ryPLKD5f4NfL7lN--IxDSoxy69S1Vq3emvBGAyL0/edit?usp=sharing')}>Download CV <i className="uil uil-file"></i></button>
          </div>
